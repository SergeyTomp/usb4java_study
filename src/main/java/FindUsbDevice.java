...
public class FindUsbDevice {
    ...
    public static void main(String argv[]) {
        ...
        try {
            usbHub = virtualRootUsbHub.getManufacturerString();
            System.err.println(usbHub);
        ...
        for (Object uD: usbDevices) {
            try {
                if(((UsbDevice)uD).getManufacturerString().equals(staticManufacturerString)){

                    usbDevice = (UsbDevice)uD;
                    break;
                }
            } catch (UsbException e) {
                e.printStackTrace();
        ...
        usbDevices = getUsbDevicesWithManufacturerString(usbDevice, staticManufacturerString);
...
//     * @param A List of any matching UsbDevice(s).
    ...
    private static short staticVendorId = 1256; /* This probably will never match */
    private static short staticProductId = 26720; /* This probably will never match */
    private static byte staticDeviceClass = UsbConst.HUB_CLASSCODE; /* This will match all hubs. :) */
    private static String staticManufacturerString = "SAMSUNG";
